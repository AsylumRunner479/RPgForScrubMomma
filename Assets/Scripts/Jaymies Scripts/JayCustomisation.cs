...
public class JayCustomisation : MonoBehaviour
{
    ...
    public JayCharacterClass charClass;
    public Vector2 scr;
    ...
    void ChooseClass(int className)
    {
        switch (className)
        {
            case 0:
                ...
                charClass = JayCharacterClass.Barbarian;
                break;
            case 1:
                ...
                charClass = JayCharacterClass.Bard;
                break;
            case 2:
                ...
                charClass = JayCharacterClass.Cleric;
                break;
            case 3:
                playerStats[0].statValue = 5;
                playerStats[1].statValue = 10;
                ...
                playerStats[5].statValue = 5;
                charClass = JayCharacterClass.Druid;
                break;
            case 4:
                playerStats[0].statValue = 15;
                ...
                playerStats[4].statValue = 5;
                playerStats[5].statValue = 5;
                charClass = JayCharacterClass.Fighter;
                break;
            case 5:
                playerStats[0].statValue = 5;
                playerStats[1].statValue = 15;
                ...
                playerStats[4].statValue = 10;
                playerStats[5].statValue = 5;
                charClass = JayCharacterClass.Monk;
                break;
            case 6:
                playerStats[0].statValue = 15;
                playerStats[1].statValue = 15;
                ...
                playerStats[4].statValue = 5;
                playerStats[5].statValue = 5;
                charClass = JayCharacterClass.Paladin;
                break;
            case 7:
                playerStats[0].statValue = 5;
                ...
                playerStats[4].statValue = 10;
                playerStats[5].statValue = 10;
                charClass = JayCharacterClass.Ranger;
                break;
            case 8:
                playerStats[0].statValue = 5;
                playerStats[1].statValue = 15;
                ...
                playerStats[4].statValue = 10;
                playerStats[5].statValue = 10;
                charClass = JayCharacterClass.Rogue;
                break;
            case 9:
                playerStats[0].statValue = 5;
                playerStats[1].statValue = 5;
                ...
                playerStats[4].statValue = 15;
                playerStats[5].statValue = 15;
                charClass = JayCharacterClass.Sorcerer;
                break;
            case 10:
                playerStats[0].statValue = 10;
                playerStats[1].statValue = 5;
                ...
                playerStats[4].statValue = 15;
                playerStats[5].statValue = 10;
                charClass = JayCharacterClass.Warlock;
                break;
            case 11:
                playerStats[0].statValue = 5;
                playerStats[1].statValue = 5;
                ...
                playerStats[4].statValue = 15;
                playerStats[5].statValue = 15;
                charClass = JayCharacterClass.Wizard;
                break;
        }
    }
}
public enum JayCharacterClass
{
    Barbarian,
    Bard,
    Cleric,
